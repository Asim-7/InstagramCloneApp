package com.example.instagramcloneapp.screens.story
            ...
            imageUri == null -> Toast.makeText(
                ...
                uploadTask.continueWithTask(Continuation<UploadTask.TaskSnapshot, Task<Uri>> { task ->
                    ...
                    if (task.isSuccessful) {
                        ...
                        val storyId = (ref.push().key).toString()     //generating random key

                        val timeEnd = System.currentTimeMillis() + 86400000 //adding one day
