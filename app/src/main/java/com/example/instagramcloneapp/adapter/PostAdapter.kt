...
import com.example.instagramcloneapp.*
...
import com.example.instagramcloneapp.screens.feed.CommentsActivity
import com.example.instagramcloneapp.screens.feed.PostDetails
...
class PostAdapter
    ...
    private fun openProfile(publisher: String) {
        val pref = mContext.getSharedPreferences("PREFS", Context.MODE_PRIVATE).edit()
        pref.putString("profileId", publisher)
        pref.apply()

        (mContext as FragmentActivity).supportFragmentManager.beginTransaction()
            .replace(R.id.fragment_container, ProfileFragment()).addToBackStack("tag").commit()
    }
        ...
        LikesRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.exists()) {
                    ...
                    //likes.text = p0.childrenCount.toString() + " like(s)"
                }
            }
        })
    ...
    private fun getTotalComments(comments: TextView, postid: String) {
        ...
        val commentssRef = FirebaseDatabase.getInstance().reference
            .child("Comments").child(postid)

        commentssRef.addValueEventListener(object : ValueEventListener {
            override fun onCancelled(p0: DatabaseError) {
            }
